    ...
    \part[4] Adam Optimizer\newline
        ...
        \begin{subparts}
            ...
            \subpart[2]First, Adam uses a trick called {\it momentum} by keeping track of $\bm$, a rolling average of the gradients:
                ...
                \answer{
                    Some time there is local minima. if using momentum, which will break out this situation leading to global minima. 
                }
            ...
            \subpart[2] Adam extends the idea of {\it momentum} with the trick of {\it adaptive learning rates} by keeping track of  $\bv$, a rolling average of the magnitudes of the gradients:
                ...
                \answer{
                    If $|\bv_i|$ is small, the update of $\btheta_i$ will be large. It will smooth gradient within different dimension, which may eliminate shake circumstance.
                }
            ...
            \subpart[2]
                ...
                \answer{
                    \alns {
                        \mathbb{E}_{p_{\text{drop}}}[\bh_\text{drop}]_i &= \gamma (p_{\T{drop}}\cdot 0 + (1 - p_{\T{drop}})h_i) = h_i \\
                        &\Rightarrow \gamma = \frac{1}{1-p_{\T{drop}}}
                    }
                }
            ...
            \answer{
                Dropout can reduce the chance to overfitting during training procedure. But during evaluation procedure, dropout should close to maintain the full network utilization and consistency in prediction.
            }
