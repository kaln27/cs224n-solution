...
from utils.parser_utils import minibatches, load_and_preprocess_data, AverageMeter, dev
...
if __name__ == "__main__":
    ...
    start = time.time()
    model = ParserModel(embeddings).to(dev)
    parser.model = model
    ...
    if not debug:
        ...
        parser.model.load_state_dict(torch.load(output_path, weights_only=False))
