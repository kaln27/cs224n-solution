...
\begin{parts}
    ...
    \answer{
        Chinese character will combined to a new phrase, so Convolutional layer will that the network consider the context of the character.
    }
    ...
    \begin{subparts}
        ...
        \answer{
            NMT model can't handle plural problem. May be in train set the culprits occur 103 times, but culprits only occurs 52 times. Find a better train set will solve this problem.
        }
        ...
        \answer{
            NMT model repeats it's output. Due to the model is not converge. Training more time will help.
        }
        ...
        \answer{
            NMT model can't translate national mourning day. Cause in train set this sentence actually occurs. But ths mount is not enough to make model 'remeber' this phrase. Add more data will help.
        }  
        ...
        \answer{
            This sentence is Cantonese, which is not occurs in the train set. The model can't translate this word proper appropriately. The solution is add more data.
        }
    ...
    \begin{subparts}
        ...
        \answer{
            ...
            \alns{
                ...
                p_1 &= \frac{4}{9}\\
                p_2 &= \frac{3}{8} \\
                BLEU &= \exp(1 - \frac{11}{9}) \times \exp(0.5 \times \log(frac{4}{9}) + 0.5 \times \log(\frac{3}[8])) \\
                &= 0.543
            }
            for $c_2$:
            \alns{
                ...
                p_1 &= 1 \\
                p_2 &= \frac{3}{5} \\
                BLEU &= 1 \times \exp(0.5 \times \log(1) + 0.5 \times \log(\frac{3}{5})) \\
                &= 0.895
            }
        }
        ...
        \answer{
            The second NMT translation is considered to be better. I don't agree that, the second one in error in syntactical.
        }
        ...
        \answer{
            ...
            \alns{
                ...
                p_1 &= \frac{4}{9}\\
                p_2 &= \frac{3}{8} \\
                BLEU &= 1 \times \exp(0.5 \times \log(frac{4}{9}) + 0.5 \times \log(\frac{3}[8])) \\
                &= 0.678
            }
            for $c_2$:
            \alns{
                ...
                p_1 &= \frac{3}{6} \\
                p_2 &= \frac{1}{5} \\
                BLEU &= 1 \times \exp(0.5 \times \log(\frac{3}{6}) + 0.5 \times \log(\frac{1}{5})) \\
                &= 0.601
            }
            The first NMT translation recvives the higher BLEU score. I agree with that.
        }
        
        
        \subpart[2] Due to data availability, NMT systems are often evaluated with respect to only a single reference translation. Please explain (in a few sentences) why this may be problematic. In your explanation, discuss how the BLEU score metric assesses the quality of NMT translations when there are multiple reference transitions versus a single reference translation.
        \answer{
            Because the sentence has different form and word. If only have one reference translation, which mean the output translation must use the same word and sentence form with reference one.

            If there have different reference translations, BLEU score will look all of them to get the 'average' score, which is more fair then only have one reference.
        }
        ...
        \answer{
            Advantages: \begin{enumerate}
                ...
                \item Consistency and Objectivity
            \end{enumerate}
            Disadvantages: \begin{enumerate}
                \item Limited Contextual Understanding
                \item Sensitivity to Reference Variability
            \end{enumerate}
        }
    ...
    \begin{subparts}
        ...
        \answer{
            example : i was able to provide clarification on some of the matters which were raised at that meeting.
            iter 200: it is not that the united nations of the united nations of the united nations.
            iter 3000: i also wish to clarify a number of cases in the conference on the conference.
            last iter: i have also clarified a number of matters raised at the session.
            As you can see, with the training goes, the result improved.
        }
        ...
        \answer{
            \begin{enumerate}
                \item i have also clarified a number of matters raised at the session.
                \item i have also clarified a number of matters raised at the meeting.
                \item i have also clarified a number of matters raised at the session of the conference.
            \end{enumerate}
            In here, I think the second hypothesis is best even if it score is lower then the first one.
        }
