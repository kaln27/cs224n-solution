...
class BertSentimentClassifier(torch.nn.Module):
    ...
    def __init__(self, config):
        ...
        ### TODO
        self.head_dropout = torch.nn.Dropout(config.hidden_dropout_prob)
    ...
    def forward(self, input_ids, attention_mask):
        ...
        ### TODO
        out_dir = self.bert(input_ids, attention_mask)
        pooler_output = out_dir['pooler_output']
        return self.head(self.head_dropout(pooler_output))
